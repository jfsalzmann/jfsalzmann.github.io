...
$(document).on("click",function(t){$(".author__urls").is(":visible")&&!$(t.target).closest(".author__urls").length&&($(".author__urls").fadeOut("fast"),$(".author__urls-wrapper button").removeClass("open"))}),
