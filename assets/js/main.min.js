...
$(document).ready(function(){
    $("details").on("toggle", function() {
        if (!this.open) return;
        $others = $("details").not(this).filter("[open]").removeAttr("open");
